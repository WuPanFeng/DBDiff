        ...
        private void ProgressForm_Activated(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsProcessing)
                {
                    ...
                    this.ErrorLocation = "加载 " + databaseProgressControl1.DatabaseName;
                    Source = genData1.Process();
                    databaseProgressControl2.Message = "完成";
                    databaseProgressControl2.Value = Generate.MaxValue;
                    this.ErrorLocation = "加载 " + databaseProgressControl2.DatabaseName;
                    ...
                    databaseProgressControl1.Message = "完成";
